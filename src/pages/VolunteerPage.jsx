...
export default function VolunteerPage() {
    ...
    return (
      <div className="px-4 sm:px-14 mb-8 bg-gray-50 min-h-screen">
  {/* Welcome Message */}
  ...
  <h2 className="text-xl sm:text-3xl font-bold my-4 text-left">
  ...
  <div className="flex flex-wrap gap-4 my-6 sm:my-10">
    ...
    <div className="w-full sm:max-w-xs">
      ...
      <button
        ...
        className="mt-6 w-full xl:w-fit bg-blue-500 hover:bg-blue-600 text-white font-bold px-6 py-2 rounded"
      >
        Sök
      </button>
    </div>
  ...
  <div className="my-10 max-w-screen-sm">
    ...
    <button
      onClick={createUser}
      className="mt-6 w-full sm:w-1/2 bg-blue-500 hover:bg-blue-600 text-white font-bold px-6 py-2 rounded"
    >
      Skapa Användare
    </button>
  </div>
