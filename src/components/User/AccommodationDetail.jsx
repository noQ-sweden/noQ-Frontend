                ...
                <div
                  ...
                  <div className="grid grid-cols-3">
                    ...
                    <div className=" md:col-span-2 ">
                      <p className="text-base grid justify-items-start ">
                        {details.name}
                      </p>
                  ...
                  <div className="grid grid-cols-3 justify-end">
                    ...
                    <div className="grid col-span-2  justify-self-end md:mr-20 ">
                      <img
                        src={details.imageSrc}
                        alt={details.name}
                        className=" w-60 justify-self-center border-2 border-solid border-grey p-2"
                      />
                      <div className="grid grid-cols-3 gap-2 pt-2">
                        <img
                          src={details.imageSrc}
                          alt={details.name}
                          className=" w-20 border-2 border-solid border-grey p-2"
                        />
                        <img
                          src={details.imageSrc}
                          alt={details.name}
                  ...
                  <div className=" flex justify-end mx-20">
                    <Link to={`/accommodations/${details.id}/booking`}>
                    <button
                      className="
                                bg-green-600
                                hover:bg-green-700
