    ...
    return (
        ...
        >
            {buttons.map((button, index) => (
                <button
                    key={button.label}
                    className={`py-2 px-8 font-sans text-sm font-semibold leading-5 tracking-normal text-left focus:outline-none 
                        ${selectedButton === button.label ? 'bg-[#E5E7EB]' : 'bg-[#FDFDFD]'}
                    ...
                    style={{
                        border: selectedButton === button.label ? '1px solid transparent' : '1px solid #D1D5DB',
                    }}
                >
                    {button.label}
                </button>
