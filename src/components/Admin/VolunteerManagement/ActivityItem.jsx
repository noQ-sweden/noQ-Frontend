    ...
    <>
      <div className="bg-white rounded-xl p-4 shadow-sm border mb-4">
        ...
        <div className="flex items-center gap-4 mt-2">
          ...
          <button onClick={() => setShowDelete(true)} className="text-sm font-medium text-red-600">
            Ta bort
          </button>
        </div>
      </div>
      ...
      {showDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-xl p-6 w-[90%] max-w-sm shadow-lg space-y-4 text-center">
            ...
            <div className="flex justify-center gap-4 mt-4">
              <button
                ...
                className="bg-[#B34A3C] text-white px-4 py-2 rounded-3xl flex items-center"
              >
                <CheckIcon className="w-5 h-5 text-white mr-1" />
                Ja
              </button>
              <button
                onClick={() => setShowDelete(false)}
                className="bg-[#1C4915] text-white px-4 py-2 rounded-3xl flex items-center"
              >
                <XMarkIcon className="w-5 h-5 text-white mr-1" />
                Nej
              </button>
            </div>
          </div>
